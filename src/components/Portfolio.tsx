...
const portfolioItems = [
  {
    ...
    description: 'A dynamic brand story showcasing innovation and growth for a tech startup.',
  ...
  },
  {
    ...
    category: 'Food Restaurant',
    description: 'Compelling narrative about urban renewal and community transformation.',
  ...
  },
  {
    ...
    category: 'Food Restaurant',
    description: 'High-fashion promotional video with stunning visuals and motion graphics.',
  ...
  },
  {
    ...
    category: 'Food Restaurant',
    description: 'Fast-paced highlight reel capturing the energy of a corporate event.',
